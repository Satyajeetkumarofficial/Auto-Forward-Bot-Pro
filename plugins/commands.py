...
main_buttons = [[
    InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='https://t.me/satyajeetkumarofficial')
],[
    ...
    InlineKeyboardButton('💝 ғᴏʟʟᴏᴡ ɪɴsᴛᴀɢʀᴀᴍ ᴀᴄᴄᴏᴜɴᴛ', url='https://www.instagram.com/satyajeetkumarofficial')
],[
